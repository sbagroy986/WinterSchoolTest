...
prx.types.toolbar = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-toolbar" '+((prx.componentsHelper.getProp(item.overlay,'boolean'))? 'data-mpoverlay="1"': '')+'>';
		cR += '<style>';
		...
		cR += '<div class="inner liveUpdate-backgroundColor changeProperty-backgroundColor">';
		cR += '</div>';
...
prx.types.header = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-header" '+((prx.componentsHelper.getProp(item.overlay,'boolean'))? 'data-mpoverlay="1"': '')+'>';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#' + _id + ' {background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+';text-align: center;line-height:'+_dims.height+'px;'+_props+' text-shadow: 0 -1px 0 rgba(0,0,0,0.5);}';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
		cR += '<div class="inner liveUpdate-backgroundColor liveUpdate-textColor changeProperty-backgroundColor changeProperty-textFont changeProperty-textSize changeProperty-textColor"><span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text')+'</span>';
		cR += '</div>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
		return cR;
...
prx.types.tabbar = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR = cR +  '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-tabbar '+((prx.componentsHelper.getProp(item.iconSize,'icon-size')==4) ? 'large-icons' : '') +'" '+((prx.componentsHelper.getProp(item.overlay,'boolean'))? 'data-mpoverlay="1"': '')+' style="'+_bg+'">';
		if(prx.componentsHelper.getProp(item.maskIcons,'boolean') && $.browser.webkit && !prx.editor) {
			cR = cR += '<style>';
			cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
			cR += '#'+_id+' li input:checked + label em { background: ' + prx.tabbargradient + '!important; }</style>';
		} else {
			cR += '<style>';
			cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
			cR += '</style>';
...
prx.types.button2 = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		case 'right':
			...
			content += 'border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius') + ';';
			break;
		case 'left':
		...
		var cR = "";
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-button '+((!eval(prx.componentsHelper.getProp(item.bgGradient,'other'))) ? 'type-button-no-gradient' : '') + '">';
...
prx.types.fullwidthbutton = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-fullwidthbutton">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#' + _id + ' .inner-btn { ' + _btnBg+';font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont,'font-family')+_props+'; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+';line-height: '+(parseInt(prx.componentsHelper.getRealDims(item,symbol).height)-6*prx.componentsHelper.getScale(item))+'px; }';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
		cR += '<div class="inner-btn liveUpdate-backgroundColor liveUpdate-textColor liveUpdate-borderColor changeProperty-text changeProperty-backgroundColor changeProperty-textColor changeProperty-textFont changeProperty-textSize changeProperty-borderColor">';
...
prx.types.buttongroup = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = "";
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-buttongroup '+((!eval(prx.componentsHelper.getProp(item.bgGradient,'other'))) ? 'type-buttongroup-no-gradient' : '')+'">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
...
prx.types.segmentedcontrol = {
	name: "segmentedcontrol"
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-segmentedcontrol style-'+item.style+'">';

		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#' + _id + ' input:checked + label { '+bgBtnCssActive+' background-color: '+prx.componentsHelper.getProp(item.activeBackgroundColor,'color-background')+'; color: '+prx.componentsHelper.getProp(item.activeTextColor,'color-text')+'; }</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

		cR += '<ul class="label-container liveUpdate-borderColor liveUpdate-backgroundColor liveUpdate-textColor changeProperty-backgroundColor changeProperty-textColor changeProperty-textFont changeProperty-textSize changeProperty-borderColor" style="'+bgBtnCss+' background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+_props+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+';">';
		$.each(item.options, function(i,elm){
			...
			if(i == 0) {
				_style += 'border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+' 0 0 '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+';';
			}
			if(i == item.options.length -1) {
				_style += 'border-radius: 0 '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+' '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+' 0;';
			}
...
prx.types.pagecontroller = {
	...
	,onDisplay: function(item,containerid,symbol) {
		var _id = (!containerid) ? item.id : containerid+'-'+item.id;
		var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-pagecontroller ' + ((item.vertical) ? 'type-pagecontroller-vertical' : '') + '">';

		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' label { background-color: '+prx.componentsHelper.getProp(item.buttonColor,'color-bakground')+'; height: ' + prx.componentsHelper.getProp(item.buttonSize,'num-other') + 'px; width: ' + prx.componentsHelper.getProp(item.buttonSize,'num-other') + 'px; border-radius:' + prx.componentsHelper.getProp(item.buttonBorderRadius,'border-radius')+'; ' + ' margin-'+((prx.componentsHelper.getProp(item.vertical,'boolean')) ? 'bottom' : 'right')+': '+prx.componentsHelper.getProp(item.buttonSpacing,'num-other')+'px;}';
...
prx.types.label = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-text liveUpdate-textColor liveUpdate-backgroundColor changeProperty-backgroundColor changeProperty-textColor changeProperty-textFont changeProperty-textSize changeProperty-textAlign">';

		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#' + _id + '{color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+_props+_shadow+' text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';}';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

		cR += '<div style="overflow: hidden; width: 100%; height: 100%;" class="changeProperty-text"> <span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text')+'</span>';
		cR += '</div>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
		return cR;
...
prx.types.textfield = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-textfield type-textfield-'+prx.componentsHelper.getProp(item.inputtype,'other')+'">';

		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' input, #'+_id+' .faux-input { background-color: '+_bg+'; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; border-radius:'+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+'; '+ _props + ' line-height: '+ (_dims.height - parseInt(prx.componentsHelper.getProp(item.borderWidth,'num-border-width'))*2) +'px }';
...
prx.types.radiobutton = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-radio">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
...
prx.types.checkbox = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-checkbox">';
...
prx.types.checkboxlist = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-checkboxlist">';

		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#' + _id + ' input:checked + label { background: '+prx.componentsHelper.getProp(item.activeBackgroundColor,'color-background')+'; color: '+prx.componentsHelper.getProp(item.activeTextColor,'color-text')+'; }</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

		if(prx.componentsHelper.getProp(item.horizontal,'boolean')) { _hor += ' horizontal' }
		
		cR += '<div class="label-container liveUpdate-backgroundColor liveUpdate-textColor liveUpdate-borderColor changeProperty-backgroundColor changeProperty-textColor changeProperty-borderColor changeProperty-textFont changeProperty-textSize changeProperty-textAlign '+_hor+'" style="background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; border-radius:'+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+'; '+_props+' text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';">';
		...
		$.each(item.checkboxes, function(i,elm){
			...
			if(i == 0) {
				if(!prx.componentsHelper.getProp(item.horizontal,'boolean')) {
					_style += 'border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-tl')+' '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-tr')+' 0 0';
				} else {
					_style += 'border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-tl')+' 0 0 '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-bl');
				}
			}
			if(i == item.checkboxes.length - (1*prx.componentsHelper.getScale(item))) {
				if(!prx.componentsHelper.getProp(item.horizontal,'boolean')) {
					_style += 'border-radius: 0 0 '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-br')+' '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-bl');
				} else {
					_style += 'border-radius: 0 '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-tr')+' '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-br')+' 0';
				}
			}
...
prx.types.flipswitch = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-flipswitch '+((prx.componentsHelper.getProp(item.ios5,'boolean')) ? 'flipswitch-ios5' : '') +'">';
		...
		if(!prx.componentsHelper.getProp(item.ios5,'boolean')) {
			...
			cR += '#'+_id+' label { border-radius:'+prx.componentsHelper.getProp(item.height,'border-radius')+' ; }';
			cR += '#'+_id+' .activelabel { width: '+(prx.componentsHelper.getProp(item.width,'num-other')-(2*prx.componentsHelper.getScale(item)))+'px; line-height: '+(prx.componentsHelper.getProp(item.height,'num-other')-(2*prx.componentsHelper.getScale(item)))+'px; padding-right: '+parseInt(prx.componentsHelper.getProp(item.height,'num-other')*0.75)+'px; background-color: '+prx.componentsHelper.getProp(item.activeLabelColor,'color-background')+'; color: '+prx.componentsHelper.getProp(item.activeLabelTextColor,'color-text')+'; border-radius: '+(prx.componentsHelper.getProp(item.height/2,'border-radius'))+' 0 0 '+(prx.componentsHelper.getProp(item.height/2,'border-radius'))+'; }'
			cR += '#'+_id+' .inactivelabel { width: '+(+prx.componentsHelper.getProp(item.width,'num-other')-(2*prx.componentsHelper.getScale(item)))+'px; line-height: '+(prx.componentsHelper.getProp(item.height,'num-other')-(2*prx.componentsHelper.getScale(item)))+'px; padding-left: '+parseInt(prx.componentsHelper.getProp(item.height,'num-other')*0.75)+'px; background-color: '+prx.componentsHelper.getProp(item.inactiveLabelColor,'color-background')+'; color: '+prx.componentsHelper.getProp(item.inactiveLabelTextColor,'color-text')+'; border-radius: 0 '+(prx.componentsHelper.getProp(item.height/2,'border-radius'))+' '+(prx.componentsHelper.getProp(item.height/2,'border-radius'))+' 0; }'
...
prx.types.textarea = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-textarea">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
...
prx.types.slider = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-slider '+((prx.componentsHelper.getProp(item.vertical,'boolean')) ? 'type-slider-vertical' : '')+'">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
...
prx.types.picker = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-picker"><div class="outer liveUpdate-containerColor" style="background-color: '+prx.componentsHelper.getProp(item.containerColor,'color-background')+';">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
...
prx.types.listcomplex = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var _BRstyle = "";
		var _icon = "";
		var _borderRadius = prx.componentsHelper.getProp(item.borderRadius,'border-radius');
		var _activevalue = "";
		var _inactivevalue = "";
		var _thumbnail = "";
		var _activetext = "";
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-list">';
		...
		if(prx.componentsHelper.getProp(item.style,'other') == "grouped") {
			cR += '#' + _id + ' li:first-child label { border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-tl')+' '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-tr')+' 0 0; }'
			cR += '#' + _id + ' li:last-child label { border-radius: 0 0 '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-br')+' '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-bl')+'; }'
		}
...
prx.types.alert = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-alert">';
...
prx.types.actionsheet = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-actionsheet">';
		...
		cR += '<div  class="actionsheet-inner liveUpdate-backgroundColor changeProperty-backgroundColor"  style="padding: '+prx.componentsHelper.getProp(item.padding,'num-other')+'px; '+_bg+' background-size: 100% '+20*prx.componentsHelper.getScale(item)+'px; background-repeat: no-repeat; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+';">';
		$.each(item.buttons, function(i,elm){
...
prx.types.progressview = {
	...
	,onDisplay: function(item,containerid,symbol) {
		var _id = (!containerid) ? item.id : containerid+'-'+item.id;
		var cR = '';
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-progressview">';
...
prx.types.popover = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		if(eval(prx.componentsHelper.getProp(item.hasHeader,'boolean'))) {
			...
			var _borderRadius =  'border-radius: 0 0 ' + prx.componentsHelper.getProp(item.borderRadius,'border-radius-br') + ' ' +prx.componentsHelper.getProp(item.borderRadius,'border-radius-bl') + ';';
		} else {
			_height2 = _height;
			var _borderRadius = 'border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+';';
		}

		cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-popover">';
